...
public abstract class AExampleFragment extends RajawaliFragment implements OnClickListener {
     ...
     @Override public void onCreate(Bundle savedInstanceState) {
          ...
          // if ( bundle == null || !bundle.containsKey(BUNDLE_EXAMPLE_URL) ) { throw new IllegalArgumentException(getClass().getSimpleName() + " requires " +
          // BUNDLE_EXAMPLE_URL + " argument at runtime!"); }
     ...
     @Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
          mLayout = (FrameLayout) inflater.inflate(R.layout.rajawali_fragment, container, false);
