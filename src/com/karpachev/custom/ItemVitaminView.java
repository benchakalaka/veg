...
@EViewGroup ( R.layout.list_vitamin ) public class ItemVitaminView extends RelativeLayout implements android.view.View.OnClickListener {
     ...
     public ItemVitaminView ( Context context , Activity act ) {
          super(context);
          this.context = act;
